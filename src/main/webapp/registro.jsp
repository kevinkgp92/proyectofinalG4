...
<body>
	...
	<div>
		...
		<form class="form" action="ServletRegistro" method="post" name="formRegistro"
			...
			<label class="fadIn second" for="contraseña">Contraseña:</label> <input
				class="fadIn third" type="password" name="contraseña" id="password"
				placeholder="Escriba aquí una contraseña..." /> <br>
			<label class="fadIn second" for="telefono">Teléfono: </label> <input 
				type="text" name="telefono" id="asunto"
				placeholder="Escriba aquí su número de teléfono..." /> <br>
			<label class="fadIn second" for="email">Email: </label> <input 
				type="text" name="email" id="asunto"
				placeholder="Escriba aquí su email..." /> <br>
